...
import com.pr.parser.service.PhonePublisher;
...
public class ScrappingController {
    ...
    @GetMapping("/filter")
    public Mono<FilteredProductsResult> getFilteredProducts(@RequestParam(name = "search") String search) {
        return scrappingService.getFilteredProducts(search);
    }

    @GetMapping(value = "/filter-custom")
    public ResponseEntity<String> getFilteredProductsCustomSerialization(@RequestParam(name = "search") String search,
